...
int solve_12_03(int avgc, char* argv[])
{
	...
	// 创建着色器类
	// 与光照计算相关的着色器类
	Shader lightingShader("./file/12_light_casters/shader3/cube.vs", "./file/12_light_casters/shader3/cube.fs");
	// 与“发光立方体”或“立方体光源”相关的着色器
	Shader lightCubeShader("./file/12_light_casters/shader3/light_cube.vs", "./file/12_light_casters/shader3/light_cube.fs");
	...
	*/
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		// 我们将扩散强度设置得稍高一些；正确的照明条件因不同的照明方法和环境而异。
		// 每个环境和照明类型都需要一些调整，以获得最好的环境。
