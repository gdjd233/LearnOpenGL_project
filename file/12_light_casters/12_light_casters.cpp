...
int solve_12(int avgc, char* argv[])
{
	// OpenGL
	...
	// 创建着色器类
	// 与光照计算相关的着色器类
	Shader lightingShader("./file/12_light_casters/shader/cube.vs", "./file/12_light_casters/shader/cube.fs");
	// 与“发光立方体”或“立方体光源”相关的着色器
	Shader lightCubeShader("./file/12_light_casters/shader/light_cube.vs", "./file/12_light_casters/shader/light_cube.fs");
