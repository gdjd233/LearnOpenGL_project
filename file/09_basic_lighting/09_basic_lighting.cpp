...
int solve_09(int avgc, char* argv[])
{
	// OpenGL
	...
	// 创建着色器类
	// 与光照计算相关的着色器类
	Shader lightingShader("./file/09_basic_lighting/shader/cube.vs", "./file/09_basic_lighting/shader/cube.fs");
	// 与“发光立方体”或“立方体光源”相关的着色器
	Shader lightCubeShader("./file/09_basic_lighting/shader/light_cube.vs", "./file/09_basic_lighting/shader/light_cube.fs");
