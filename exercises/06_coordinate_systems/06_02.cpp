...
int work_06_02(int avgc, char* argv[])
{
	// OpenGL
	...
	// 创建着色器类
	Shader ourShader("./exercises/06_coordinate_systems/shader2/vertex.vs", "./exercises/06_coordinate_systems/shader2/fragment.fs");
