...
int work_09_03(int avgc, char* argv[])
{
	...
	// 创建着色器类
	// 与光照计算相关的着色器类
	Shader lightingShader("./exercises/09_basic_lighting/shader3/cube.vs", "./exercises/09_basic_lighting/shader3/cube.fs");
	// 与“发光立方体”或“立方体光源”相关的着色器
	Shader lightCubeShader("./exercises/09_basic_lighting/shader3/light_cube.vs", "./exercises/09_basic_lighting/shader3/light_cube.fs");
