...
int work_02_03(int avgc, char* argv[])
{
	// OpenGL
	...
	*/
	...
	if (!success) {
		...
		std::cout << "ERROR::PROGRAM::SHADER1::LINKING_FAILED\n" << infoLog << std::endl;
	}
	// 获取着色器程序的链接状态
	...
	if (!success) {
		...
		std::cout << "ERROR::PROGRAM::SHADER2::LINKING_FAILED\n" << infoLog << std::endl;
	}
