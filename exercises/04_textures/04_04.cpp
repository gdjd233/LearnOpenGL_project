...
static void processInput(GLFWwindow* window, Shader& ourShader, float& factor);
...
int work_04_04(int avgc, char* argv[])
{
	// OpenGL
	...
	// 创建着色器类
	Shader ourShader("./exercises/04_textures/shader4/vertex.vs", "./exercises/04_textures/shader4/fragment.fs");
	...
	*/
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		// 按输入上下键改变可见度
		processInput(window, ourShader, factor);
